...
export const createMayraRegistrationSchema = z.object({
  body: z.object({
    ...
    nomineeAadhaar: z.string().optional().nullable(),
    nominee_aadhar: z.string().optional().nullable(),
    nominee_aadhaar: z.string().optional().nullable(),
    nomineeAadharNumber: z.string().optional().nullable(),
    nomineeAadhaarNumber: z.string().optional().nullable(),
